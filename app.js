...
const MONGO_URL ="mongodb+srv://rajputviraj0007:CtywgtVRp2NyfYHH@cluster0.fkpdftm.mongodb.net/wanderlust";
...
app.post("/listings" ,
 ...
 let result =listingSchema.validate(req.body); // validate the data using Joi schema
console.log(result);
if(result.error) {
